	  ...
	  //配置
	    ...
	    //获取数据
	     $scope.forPages = function(page,size){
	        ...
	        $http.get("/commission/queryCommissionAll.do?currentPage="+page+"&pageSize="+size+"&userid="+userid+"&roleid="+roleid+"&dealStartTime="+dealStartTime+"&dealEndTime="+dealEndTime).success(function(Data){  
