...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../system/css/securityCheckReport.css" />
	<title>用户管理</title>
</head>
    	...
    	<div class="coursePanel">
     	...
     	<table class="table table-bordered table-hover table-striped">                    
               ...
               <tr ng-repeat="tmp in list | filter:query | orderBy:col:desc track by $index" data-id="{{tmp.id}}">
                   ...
                   <td ng-bind="tmp.result"></td>
                   <td ng-bind="tmp.startTime"></td>
               </tr>
		</table>
        <!-- 分页 -->
	 	<nav>
...
<script type="text/javascript" src="../system/js/securityCheckReport.js"></script>
</body>
</html>